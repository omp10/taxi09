...
const ActivityRoute = lazy(() => import('./modules/user/pages/activity/ActivityRoute'));
...
const AdminHireDriverBookings = lazy(() => import('./modules/admin/pages/bookings/HireDriverBookings'));
const AdminSharedTaxiBookings = lazy(() => import('./modules/admin/pages/bookings/SharedTaxiBookings'));
...
const AdminRentalFleet = lazy(() => import('./modules/admin/pages/fleet/RentalFleet'));
const AdminRentalVehicleSubcategories = lazy(() => import('./modules/admin/pages/price-management/RentalVehicleSubcategories'));
        ...
        <MainLayout>
          <Suspense
            ...
            <Routes>
              ...
              <Route path="/taxi/user/activity" element={<ActivityRoute />} />
              ...
              <Route path="/admin" element={<AdminLayout />}>
                ...
                <Route path="bookings/driver-engagements" element={<AdminHireDriverBookings />} />
                <Route path="bookings/shared-taxi" element={<AdminSharedTaxiBookings />} />
                ...
                <Route path="pricing">
                  ...
                  />
                  <Route path="rental-fleet" element={<AdminRentalFleet />} />
                  <Route
                  ...
                  />
                  <Route
                    path="rental-vehicle-subcategories"
                    element={<AdminRentalVehicleSubcategories />}
                  />
                  <Route
                    path="rental-vehicle-subcategories/create"
                    element={<AdminRentalVehicleSubcategories mode="create" />}
                  />
                  <Route
                    path="rental-vehicle-subcategories/edit/:id"
                    element={<AdminRentalVehicleSubcategories mode="edit" />}
                  />
                  <Route
