...
function LandingPage() {
  ...
  const appLinks = [
    {
      label: 'User App',
      href: 'https://play.google.com/store/apps/details?id=com.Taxi09.user',
    },
    {
      label: 'Driver App',
      href: 'https://play.google.com/store/apps/details?id=com.Taxi09.driver',
    },
  ];
        ...
        <div className="new-top-bar">
          <div className="new-logo-container">
             <a href="/" className="new-logo">
               <span style={{color: '#333'}}>Taxi09</span>
             </a>
          </div>
        ...
        <header className="new-main-header">
          ...
          <div className="new-nav-container">
            ...
            <div className="new-nav-actions">
              ...
              <button className="new-book-btn hidden-mobile" onClick={() => window.open('https://play.google.com/store/apps/details?id=com.Taxi09.user', '_blank')}>Book a Taxi</button>
        ...
        <section id="home" className="new-hero-section">
          <div className="new-hero-left">
            ...
            <div className="new-hero-cta-row">
              <button className="new-hero-action-btn" onClick={() => window.open('https://play.google.com/store/apps/details?id=com.Taxi09.user', '_blank')}>Book Your Ride</button>
      ...
      <section className="check-us-out-section">
        ...
        <div className="check-us-out-card">
          ...
          <div className="check-us-out-content">
            <h3 className="check-us-out-title">Join the Taxi09 Community</h3>
            ...
            <div className="check-us-out-socials-container">
              <a 
                href="https://www.facebook.com/people/Taxi09/61590718764212" 
                target="_blank" 
              ...
              <a 
                href="https://www.instagram.com/Taxi09official?igsh=MWQ3cWoxazJ1ZGV1OQ%3D%3D" 
                target="_blank" 
                rel="noopener noreferrer" 
              ...
              <a 
                href="https://youtube.com/@Taxi09official?si=RfVhOYUay--g9BhB" 
                target="_blank" 
                rel="noopener noreferrer" 
      ...
      <footer id="contact" className="new-landing-footer">
          ...
          <div className="newsletter-content">
            ...
            <div className="newsletter-text">
              ...
              <form className="newsletter-form">
                ...
                <button type="button" onClick={() => window.open('https://play.google.com/store/apps/details?id=com.Taxi09.user', '_blank')}>Book Now →</button>
              </form>
            </div>
          </div>
        </div>
        ...
        <div className="footer-main-content">
          <div className="footer-col-1">
            ...
            <div className="footer-website">www.Taxi09.com</div>
          </div>
        ...
        <div className="footer-bottom-bar">
          ...
          <div className="footer-copyright">
            Copyright 2026 © All Right Reserved Design by Taxi09
          </div>
        </div>
      </footer>
    </div>
