...
const legalContent = {
  terms: {
    ...
    icon: ScrollText,
    intro:
      'These terms are shown from the latest legal document provided for Taxi09 users and include the applicable bike, package, auto, and cab clauses.',
  ...
  privacy: {
    ...
    icon: ShieldCheck,
    intro:
      'This privacy policy is shown from the latest legal document provided for Taxi09 users and explains how information is collected, used, processed, stored, and protected.',
