  ...
  const links = [
    {
      ...
      url: 'https://play.google.com/store/apps/details?id=com.Taxi09.user',
      type: 'Customer App',
  ...
  return (
    <div className="links-page-container">
      ...
      <div className="links-banner">
        <img src={bannerImg} alt="Taxi09 Banner" className="banner-image" />
        <div className="banner-gradient"></div>
      </div>

      <div className="links-content-wrapper">
        <header className="links-header">
          <h1 className="links-title">Download <span className="highlight">Taxi09</span></h1>
          ...
          <div className="social-links-grid">
            ...
            >
              ...
              <div className="social-card-info">
                ...
                <span className="social-handle">Taxi09</span>
              </div>
            ...
            >
              ...
              <div className="social-card-info">
                ...
                <span className="social-handle">@Taxi09official</span>
              </div>
              <ExternalLink size={16} className="social-ext" />
            </a>
        ...
        <footer className="links-footer">
          ...
          <div className="footer-links">
            <a href="https://Taxi09.com" target="_blank" rel="noopener noreferrer">Visit Website</a>
