        ...
        >
          ...
          <motion.div variants={itemVariants} className="pt-4 pb-12 space-y-4">
            ...
            >
              ...
              <p className="text-[15.5px] font-bold">Delete account</p>
            </MotionButton>
            ...
            <MotionButton
              ...
              className="w-full h-16 rounded-[24px] bg-[#FFC107] text-slate-950 flex items-center justify-center gap-3 text-[16.5px] font-black shadow-xl shadow-amber-500/10"
            >
