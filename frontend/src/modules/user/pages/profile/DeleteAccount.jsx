  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#F8FAFC_0%,#F3F4F6_38%,#EEF2F7_100%)] max-w-lg mx-auto font-sans pb-12 relative overflow-hidden">
      ...
      <div className="px-5 pt-4 space-y-4">
        ...
        {/* Reason selector */}
        <div>
          <p className="text-[12px] font-black uppercase tracking-[0.26em] text-slate-500 mb-2">Why are you leaving?</p>
        ...
        <div className="space-y-2.5 pt-2">
          <MotionButton whileTap={{ scale: 0.97 }}
            ...
            className={`w-full py-4 rounded-[18px] text-[15.5px] font-black uppercase tracking-widest flex items-center justify-center gap-2 transition-all ${
              reason ? 'bg-red-500 text-white shadow-[0_6px_20px_rgba(239,68,68,0.25)]' : 'bg-slate-100 text-slate-500 cursor-not-allowed'
            }`}>
            ...
            <MotionDiv initial={{ scale: 0.92, opacity: 0, y: 40 }} animate={{ scale: 1, opacity: 1, y: 0 }} exit={{ scale: 0.92, opacity: 0, y: 40 }}
              ...
              <div className="space-y-2.5">
                ...
                <button onClick={() => setShowConfirm(false)}
                  className="w-full py-3.5 text-[14.5px] font-black text-slate-500 uppercase tracking-widest">
                  No, Keep My Account
                </button>
              </div>
            </MotionDiv>
