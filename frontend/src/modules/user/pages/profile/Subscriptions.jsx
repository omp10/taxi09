      ...
      <div className="mx-auto max-w-3xl px-4 pt-8">
        ...
        <div className="mb-6 grid gap-4 md:grid-cols-3">
          <div className="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-100">
            <p className="text-[13.5px] leading-[18px] font-black uppercase tracking-[0.2em] text-slate-500">Wallet Balance</p>
            <p className="mt-2 text-2xl font-black text-slate-900">{formatCurrency(walletBalance)}</p>
          </div>
          <div className="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-100">
            <p className="text-[13.5px] leading-[18px] font-black uppercase tracking-[0.2em] text-slate-500">Active Plans</p>
            <p className="mt-2 text-2xl font-black text-slate-900">{summary.activeCount}</p>
          </div>
          <div className="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-100">
            <p className="text-[13.5px] leading-[18px] font-black uppercase tracking-[0.2em] text-slate-500">Ride Credits</p>
