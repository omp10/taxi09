      ...
      <AnimatePresence>
        {shareToast && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="fixed top-4 left-1/2 -translate-x-1/2 z-50 bg-gray-900 text-white px-5 py-3 rounded-2xl text-[15.5px] leading-[21px] font-black shadow-2xl whitespace-nowrap"
          >
            Trip details copied
          </motion.div>
        )}
