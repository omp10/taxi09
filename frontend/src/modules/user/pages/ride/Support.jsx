...
const Support = () => {
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#F8FAFC_0%,#F3F4F6_38%,#EEF2F7_100%)] max-w-lg md:max-w-none md:mx-0 w-full mx-auto flex flex-col font-sans relative pb-24 md:pt-24 overflow-hidden">
