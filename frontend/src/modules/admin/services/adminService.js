...
export const adminService = {
  ...
  getRentalVehicleSubcategories: () => api.get('/admin/types/rental-vehicle-subcategories'),
  createRentalVehicleSubcategory: (data) => api.post('/admin/types/rental-vehicle-subcategories', data),
  updateRentalVehicleSubcategory: (id, data) => api.patch(`/admin/types/rental-vehicle-subcategories/${id}`, data),
  deleteRentalVehicleSubcategory: (id) => api.delete(`/admin/types/rental-vehicle-subcategories/${id}`),
