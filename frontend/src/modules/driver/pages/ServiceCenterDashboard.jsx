  ...
  const openLegal = (type) => {
    const contentMap = {
      driver_app: {
        ...
        Icon: UserPlus,
        description: 'Join the Taxi09 fleet as a certified driver.',
        content: `Taxi09 is always looking for professional, dedicated drivers to join our growing ecosystem. 

Steps to apply:
1. Ensure you have a valid Commercial Driving License.
2. Visit the Taxi09 Driver Onboarding center or use the Mobile App.
...
5. Once approved, you can start accepting rides and managing your earnings via the dashboard.`
      ...
      terms: {
        ...
        Icon: FileText,
        description: 'General rules for using the Taxi09 platform.',
        content: `By using the Taxi09 platform, you agree to comply with all applicable transport regulations and our safety standards.
...
• Platform Fees: Taxi09 charges a service fee for every successful booking handled.
• Account Security: You are responsible for keeping your credentials and biometric data secure.`
      ...
      privacy: {
        ...
        content: `Taxi09 takes data security seriously. We collect specific information to ensure safety and service quality.
