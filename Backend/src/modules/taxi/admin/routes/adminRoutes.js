...
import {
  ...
  createRentalVehicleSubcategory,
  createOwner,
  createOwnerBooking,
  ...
  deleteRentalVehicleSubcategory,
  deleteLanguage,
  deleteOngoingRide,
  deleteOwner,
  deleteOwnerBooking,
  ...
  updateRentalVehicleSubcategory,
...
adminRouter.get('/admin/operations/attention', getOperationsAttention);
