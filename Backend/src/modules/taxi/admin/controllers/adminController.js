...
import * as promotionsService from '../promotions/services/promotionsService.js';
...
export const getRentalVehicleSubcategories = asyncHandler(async (_req, res) =>
  ok(res, { results: await adminService.listRentalVehicleSubcategories() }),
);
export const createRentalVehicleSubcategory = asyncHandler(async (req, res) =>
  ok(res, await adminService.createRentalVehicleSubcategory(req.body)),
);
export const updateRentalVehicleSubcategory = asyncHandler(async (req, res) =>
  ok(res, await adminService.updateRentalVehicleSubcategory(req.params.id, req.body)),
);
export const deleteRentalVehicleSubcategory = asyncHandler(async (req, res) => {
  await adminService.deleteRentalVehicleSubcategory(req.params.id);
  ok(res, { deleted: true });
});
